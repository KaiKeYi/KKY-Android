...
package com.xlg.library.view.badgeview;
 ...
 * 描述:
 */
public class BGABadgeCheckBox extends AppCompatCheckBox implements BGABadgeable {
    private BGABadgeViewHelper mBadgeViewHeler;

    public BGABadgeCheckBox(Context context) {
        this(context, null);
    }

    public BGABadgeCheckBox(Context context, AttributeSet attrs) {
        this(context, attrs, android.R.attr.radioButtonStyle);
    }

    public BGABadgeCheckBox(Context context, AttributeSet attrs, int defStyleAttr) {
