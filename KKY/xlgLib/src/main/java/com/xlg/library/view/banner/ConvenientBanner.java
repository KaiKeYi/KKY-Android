package com.xlg.library.view.banner;
...
import com.xlg.library.view.banner.adapter.CBPageAdapter;
import com.xlg.library.view.banner.holder.CBViewHolderCreator;
import com.xlg.library.view.banner.listener.CBPageChangeListener;
import com.xlg.library.view.banner.listener.OnItemClickListener;
import com.xlg.library.view.banner.view.CBLoopViewPager;
...
public class ConvenientBanner<T> extends LinearLayout {
    ...
    public ConvenientBanner setPageIndicator(int[] page_indicatorId) {
        ...
        for (int count = 0; count < mDatas.size(); count++) {
            ...
            pointView.setPadding(5, 0, 5, Display.dip2Px(15));
