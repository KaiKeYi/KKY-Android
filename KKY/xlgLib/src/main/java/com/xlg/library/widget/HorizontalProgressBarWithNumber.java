...
public class HorizontalProgressBarWithNumber extends ProgressBar {
    ...
    /**
     * color of progresstxt color
     */
    protected int mProgressTextColor = DEFAULT_TEXT_COLOR;

    /**
     * color of progress number
     */
    protected int mProgressTextSize =  dp2px(DEFAULT_TEXT_SIZE);
    ...
    protected int mBigBarColor = DEFAULT_COLOR_UNREACHED_COLOR;
    protected int mMidBarColor = DEFAULT_COLOR_UNREACHED_COLOR;
    protected int mCircleColor = DEFAULT_COLOR_UNREACHED_COLOR;
    /**
    ...
    protected int mStartColor,mEndColor;
    protected int completeProgress;
    ...
    private void obtainStyledAttributes(AttributeSet attrs) {
        ...
        mTextColor = attributes.getColor(R.styleable.HorizontalProgressBarWithNumber_txt_color, DEFAULT_TEXT_COLOR);
        mTextSize = (int) attributes.getDimension(R.styleable.HorizontalProgressBarWithNumber_txt_size,mTextSize);

        mProgressTextSize = (int) attributes.getDimension(R.styleable.HorizontalProgressBarWithNumber_progress_text_size,mTextSize);
        mProgressTextColor = attributes.getColor(R.styleable.HorizontalProgressBarWithNumber_progress_text_color, DEFAULT_TEXT_COLOR);

        mReachedBarColor = attributes.getColor(R.styleable.HorizontalProgressBarWithNumber_progress_reached_color, mProgressTextColor);
        ...
        mBigBarColor= attributes.getColor(R.styleable.HorizontalProgressBarWithNumber_progress_big_color, DEFAULT_COLOR_UNREACHED_COLOR);
        mMidBarColor= attributes.getColor(R.styleable.HorizontalProgressBarWithNumber_progress_mid_color, DEFAULT_COLOR_UNREACHED_COLOR);
        mCircleColor= attributes.getColor(R.styleable.HorizontalProgressBarWithNumber_progress_circle_color, DEFAULT_COLOR_UNREACHED_COLOR);
        ...
        mStartColor =  attributes.getColor(R.styleable.HorizontalProgressBarWithNumber_start_color,mProgressTextColor);
        mEndColor =  attributes.getColor(R.styleable.HorizontalProgressBarWithNumber_end_color,mProgressTextColor);

        completeProgress = getProgress();
    ...
    public void setmBigBarColor(int mBigBarColor) {
        this.mBigBarColor = mBigBarColor;
    }

    public void setmMidBarColor(int mMidBarColor) {
        this.mMidBarColor = mMidBarColor;
    }
