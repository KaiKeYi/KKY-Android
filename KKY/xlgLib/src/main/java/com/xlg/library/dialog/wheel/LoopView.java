...
public class LoopView extends View {
    ...
    private void e() {
        ...
        for (int i1 = 0; i1 < arrayList.size(); i1++) {
            ...
            int j1 = CommonUtil.getWindowWidth();//rect.width();
            ...
            while (j1 < r) {
                ...
                if (f1 >= 90F || f1 <= -90F) {
                    ...
                    if (i2 <= n && h + i2 >= n) {
                        ...
                        Rect rect = new Rect();
                        paintA.getTextBounds(as[j1], 0, as[j1].length(),rect);
                        k1 = rect.width();
                        canvas.drawText(as[j1], (getWidth()-k1)/2, h, paintA);
                        canvas.restore();
                        canvas.save();
                        ...
                        k1 = rect.width();
                        canvas.drawText(as[j1], (getWidth()-k1)/2, h, paintB);
                        canvas.restore();
                    } else if (i2 <= o && h + i2 >= o) {
                        canvas.save();
